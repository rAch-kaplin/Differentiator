...
void WriteToTexStart(Node *root, const char* filename_tex, TeX *tex)
{
    ...
    _WRITE_NODE_TEX(buffer_TeX, &(tex->cur_len), "\\usepackage{amsmath}  \n");
    _WRITE_NODE_TEX(buffer_TeX, &(tex->cur_len), "\\usepackage{amsfonts} \n\n");

    _WRITE_NODE_TEX(buffer_TeX, &(tex->cur_len), "\\title{\\textbf{Math Differentiator}}\n");
